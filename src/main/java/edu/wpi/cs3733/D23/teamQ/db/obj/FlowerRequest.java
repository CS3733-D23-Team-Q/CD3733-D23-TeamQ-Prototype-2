...
public class FlowerRequest extends ServiceRequest {
    ...
    public FlowerRequest(int requestID, String requester, String progress, String assignee, String roomNumber, String specialInstructions, String note, String typeOfFlower, String bouquetSize) {
